...
{
    public class HandledUnitsEachElemWeightGrossNotEmptyValidator : PropertyValidator
    {
        public HandledUnitsEachElemWeightGrossNotEmptyValidator() : base("HandledUnits[{Index}].WeightGross cannot be empty.") { }
        ...
        protected override bool IsValid(PropertyValidatorContext context)
        {
            ...
            if (handledUnits.HasValue && handledUnits.Value != null && handledUnits.Value.Any())
            {
                ...
                {
                    if (handledUnit != null && string.IsNullOrWhiteSpace(handledUnit.WeightGross))
                    {
                        result = false;
