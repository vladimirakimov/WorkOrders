...
{
    public class HandledUnitsEachElemIdNotEmptyValidator : PropertyValidator
    {
        public HandledUnitsEachElemIdNotEmptyValidator() : base("HandledUnits[{Index}].Id cannot be null or empty.") { }
        ...
        protected override bool IsValid(PropertyValidatorContext context)
        {
            ...
            if (handledUnits.HasValue && handledUnits.Value != null && handledUnits.Value.Any())
            {
                ...
                {
                    if (handledUnit != null && string.IsNullOrWhiteSpace(handledUnit.Id))
                    {
                        result = false;
