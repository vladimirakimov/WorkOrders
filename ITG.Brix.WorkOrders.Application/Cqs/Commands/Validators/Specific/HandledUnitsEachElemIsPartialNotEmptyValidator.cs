...
{
    public class HandledUnitsEachElemIsPartialNotEmptyValidator : PropertyValidator
    {
        public HandledUnitsEachElemIsPartialNotEmptyValidator() : base("HandledUnits[{Index}].IsPartial cannot be empty.") { }
        ...
        protected override bool IsValid(PropertyValidatorContext context)
        {
            ...
            if (handledUnits.HasValue && handledUnits.Value != null && handledUnits.Value.Any())
            {
                ...
                {
                    if (handledUnit != null && string.IsNullOrWhiteSpace(handledUnit.IsPartial))
                    {
                        result = false;
