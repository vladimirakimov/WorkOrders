...
{
    public class HandledUnitsEachElemProductsEachElemNotNullValidator : PropertyValidator
    {
        public HandledUnitsEachElemProductsEachElemNotNullValidator() : base("HandledUnits[{Index}][{IndexProduct}] cannot be null.") { }
