...
{
    public class HandledUnitsEachElemWeightNetNotEmptyValidator : PropertyValidator
    {
        public HandledUnitsEachElemWeightNetNotEmptyValidator() : base("HandledUnits[{Index}].WeightNet cannot be empty.") { }
        ...
        protected override bool IsValid(PropertyValidatorContext context)
        {
            ...
            if (handledUnits.HasValue && handledUnits.Value != null && handledUnits.Value.Any())
            {
                ...
                {
                    if (handledUnit != null && string.IsNullOrWhiteSpace(handledUnit.WeightNet))
                    {
                        result = false;
