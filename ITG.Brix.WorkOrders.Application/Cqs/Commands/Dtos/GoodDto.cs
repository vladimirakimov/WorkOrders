namespace ITG.Brix.WorkOrders.Application.Cqs.Commands.Dtos
{
    public class GoodDto
    {
        ...
        public string CongfigurationCode { get; set; }
        public string CongfigurationDescription { get; set; }
        public string CongfigurationQuantity { get; set; }
        public string CongfigurationUnitType { get; set; }
        public string CongfigurationNetPerUnit { get; set; }
        public string CongfigurationNetPerUnitAlwaysDifferent { get; set; }
        public string CongfigurationGrossPerUnit { get; set; }
