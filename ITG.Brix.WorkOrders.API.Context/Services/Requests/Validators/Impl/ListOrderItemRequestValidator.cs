...
{
    public class ListOrderItemRequestValidator : AbstractRequestValidator<ListOrderItemRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public ListOrderItemRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as ListOrderItemRequest;
