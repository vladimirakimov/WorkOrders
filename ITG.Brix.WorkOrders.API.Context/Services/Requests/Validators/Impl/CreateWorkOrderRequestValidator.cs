...
{
    public class CreateWorkOrderRequestValidator : AbstractRequestValidator<CreateWorkOrderRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public CreateWorkOrderRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as CreateWorkOrderRequest;
