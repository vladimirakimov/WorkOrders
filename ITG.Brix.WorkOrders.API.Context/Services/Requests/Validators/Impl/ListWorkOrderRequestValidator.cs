...
{
    public class ListWorkOrderRequestValidator : AbstractRequestValidator<ListWorkOrderRequest>
    {

        private readonly IRequestComponentValidator _requestComponentValidator;

        public ListWorkOrderRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as ListWorkOrderRequest;
